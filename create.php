                        ...
                        <div id="collapseThree" class="panel-collapse collapse">
                          <div class="panel-body">
                            <div class="row">
                              <div class="col-md-6">
                                <div class="aa-checkout-single-bill">
                                  <input name="date" type="date" placeholder="Posting Date*" required>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="aa-checkout-single-bill">
                                  <input name="name_title" type="text" placeholder="Name / Title*" required>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="aa-checkout-single-bill">
                                  <textarea name="basic_ifmt" cols="8" rows="3">Basic Information*</textarea>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-md-12">
                                <div class="aa-checkout-single-bill">
                                  <textarea name="other_ifmt" cols="8" rows="3">Other Information*</textarea>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div id="collapseFour" class="panel-collapse collapse">
                          <div class="panel-body">
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="aa-checkout-single-bill">
                                  <input name="whatsapp" type="number" placeholder="Whatsapp No.*" required>
                                </div>
                              </div>

                              <div class="col-md-6">
                                <div class="aa-checkout-single-bill">
                                  <input name="contact" type="number" placeholder="Contact No.*" required>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                ...
                <div class="col-md-4">
                  <div class="checkout-right">
                    ...
                    <div class="aa-payment-method">
                      ...
                      <input name="submit" type="submit" value="Create" class="aa-browse-btn">
                    </div>
                  </div>
                </div>
              </div>
